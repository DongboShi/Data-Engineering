...
##  [1] Rcpp_1.0.0      bookdown_0.9    digest_0.6.18  
##  [4] rprojroot_1.3-2 backports_1.1.2 magrittr_1.5   
##  [7] evaluate_0.12   highr_0.7       stringi_1.4.3  
## [10] rstudioapi_0.8  rmarkdown_1.10  tools_3.5.2    
## [13] stringr_1.4.0   xfun_0.4        yaml_2.2.0     
## [16] compiler_3.5.2  htmltools_0.3.6 knitr_1.20
\end{verbatim}
...
\chapter{GUN Make}\label{gun-make}

\section{本章中我们将介绍如何使用GUN
Make语法来帮助我们实现更为便捷的可复现数据分析。对于大多数数据分析人员}\label{gun-make}
...
\includegraphics{bookdown_files/figure-latex/pressure-1.pdf}
